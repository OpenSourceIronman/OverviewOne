...
SRX_SOCKET_DEFAULT_NUM = 30000  # UDP port / socket number for S-Band Receiver
STX_SOCKET_DEFAULT_NUM = 30100  # UDP port / socket number for S-Band Transmitter
XTX_SOCKET_DEFAULT_NUM = 30200  # UDP port / socket number for X-Band Transmitter
