...
if __name__ == "__main__":
	try:
		...
		parser.add_argument("port", type=str, help = "comport number (windows) or device number (linux)")
		...
		print "--"
		print "Send Radio Command (RS-422)"
		print "Version {}".format(__version__)
		print "Tethers Unlimited Inc. (c)"

		# [1] - Create Swift Radio Interface
		radio = SwiftRadioRS422( args.port, trace=args.trace )				# internal instance trace level for debugging
