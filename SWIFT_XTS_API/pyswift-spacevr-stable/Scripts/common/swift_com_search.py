#!/usr/bin/env python
##
# @file swift_com_search.py
# @brief search available com ports for SWIFT-SDR devices and display information to console.
...
__doc__ = ("search available com ports for SWIFT-SDR devices and display information to console.")
...
if __name__ == "__main__":
	...
	swiftdb.swift_com_search(swiftradio.SwiftRadioClient(register_file_cmds=False, trace=0), radio_reg_modules)
